    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('studentrecord')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/> PERSON RECORD</Button>
            ...
            <label>Detail:</label><input class="input3" type="text" name="bookdetail"/></br>
            <label>Autor:</label><input class="input3" type="text" name="bookaudor"/></br>
            <label>Publication</label><input class="input2" type="text" name="bookpub"/></br>
            <div style="color:#453e20;"><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BSIT"/>IT<input type="radio" name="branch" value="Fantasy"/>Fantasy<input type="radio" name="branch" value="BSSE"/>Romance
            </div>   
            <label>Price:</label><input class="input4"  type="number" name="bookprice"/></br>
            <label>Quantity:</label><input class="input" type="number" name="bookquantity"/></br>
            <label>Book Photo</label><input class="choosefile"  type="file" name="bookphoto"/></br>
            </br>
            ...
            <label>Name:</label><input class="name" type="text" name="addname"/>
            </br>
            <label>Password:</label><input class="password" type="pasword" name="addpass"/>
            </br>
            <label>Email:</label><input class="email"  type="email" name="addemail"/></br>
            ...
            <div class="rightinnerdiv" style="margin-bottom: 20px;">      
...
<br>
           <label>Days</label> <input class="days" type="number" name="days"/>
